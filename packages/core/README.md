...
> The interactive `t3x` shell that some teams are experimenting with lives in a separate project and has not replaced the legacy CLI yet.
...
**Layer 1: Storage**
- ✅ Project-local `.t3x/` directory structure
- ✅ JSONL format for conversation turns
- ✅ Metadata JSON for project and branch info
- ✅ Global config file `~/.config/t3x/config.json`
