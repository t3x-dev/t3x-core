...
exports.RingExtractor = void 0;
exports.createRingExtractor = createRingExtractor;
const polarityRules_1 = require("./polarityRules");
 ...
 */
class RingExtractor {
    constructor(nlpProvider, config) {
        this.nlpProvider = nlpProvider;
        this.polarityEngine = (0, polarityRules_1.createPolarityRuleEngine)(config?.customPolarityRules);
        this.config = {
            ...DEFAULT_CONFIG,
            ...config,
        };
     ...
     */
    async extract(turnId, content, language) {
        // Handle empty content
        if (!content.trim()) {
            return (0, types_1.createEmptyRingOutput)(turnId);
        }
     ...
     */
    extractRing3(analysis, originalText) {
     ...
     */
    extractTimeWindow(entities, timeAnchor) {
...
exports.RingExtractor = RingExtractor;
/**
 * Factory function to create Ring Extractor
 */
function createRingExtractor(nlpProvider, config) {
    return new RingExtractor(nlpProvider, config);
}
//# sourceMappingURL=ringExtractor.js.map