...
export {
  ...
  compileYOpsMappingFold,
  compileYOpsMappingKeyOmit,
  compileYOpsMappingKeyPick,
  compileYOpsMappingKeyRename,
  compileYOpsMappingMerge,
  compileYOpsMappingNest,
  compileYOpsMappingPopulate,
  compileYOpsMappingSplit,
  ...
  compileYOpsSequenceSort,
  compileYOpsSequenceUnique,
