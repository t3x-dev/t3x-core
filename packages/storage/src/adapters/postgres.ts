...
async function initializeSchema(sql: postgres.Sql): Promise<void> {
  ...
  await sql.unsafe(`
    ...
    -- 2026-04-26: suggestion-vs-baseline (RFC docs/2026-04-26-extract-suggestion-vs-baseline-rfc.md)
    ...
    -- the latest attempt while preserving the audit trail.
    ...
    ALTER TABLE users ADD COLUMN IF NOT EXISTS default_provider TEXT;
