...
export function createApp(options?: CreateAppOptions): CreateAppResult {
  ...
  api.doc('/openapi.json', {
    ...
    tags: [
      ...
      { name: 'Workspace Validation', description: 'Workspace candidate validation evidence' },
      { name: 'Commits', description: 'Version control commits' },
      { name: 'Artifacts', description: 'Deterministic artifacts generated from commits' },
