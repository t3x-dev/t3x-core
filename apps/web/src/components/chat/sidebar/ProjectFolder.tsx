  ...
  const folderButton = (
    <button
      ...
      className={cn(
        ...
        isActive
          ? "border-[var(--accent-commit)]/25 bg-[var(--surface-panel)]/55 text-[var(--text-primary)] shadow-none before:absolute before:inset-y-2 before:left-0 before:w-0.5 before:rounded-full before:bg-[var(--accent-commit)] before:content-['']"
