...
export function ProjectShell({
  ...
  return (
    <div className="flex h-dvh min-h-[680px] flex-col overflow-hidden bg-[var(--surface-app)] text-[var(--text-primary)] [--text-base:14px] [--text-lg:16px] [--text-sm:13px] [--text-xs:12px]">
      <header className="relative z-20 flex shrink-0 flex-col border-b border-[var(--stroke-divider)] bg-[var(--surface-elevated)] px-3 min-[1200px]:h-14 min-[1200px]:flex-row min-[1200px]:gap-6 min-[1200px]:px-5">
