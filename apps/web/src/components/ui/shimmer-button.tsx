    ...
    return (
      <button
        ...
        className={cn(
          ...
          'transform-gpu transition-transform duration-[var(--duration-slow)] ease-in-out active:translate-y-px',
          className
        )}
        ref={ref}
        {...props}
      >
        ...
        <div
          className={cn(
            ...
            // transition
            'transform-gpu transition-all duration-[var(--duration-slow)] ease-in-out',
