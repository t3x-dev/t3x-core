...
import { GitCommit, GitMerge, PenSquare, Sparkles, MessageSquare, MessageSquarePlus, Plus, Twitter, FileText, Mail, MessageCircle, Rocket, FlaskConical, CheckCircle, XCircle, Loader2, ChevronDown } from 'lucide-react'
        ...
        >
          <Button
            ...
            className={cn(
              ...
              styles.accent,
              data.branchType === 'main' ? 'border-blue-400 hover:bg-blue-50' : 'border-orange-400 hover:bg-orange-50'
            )}
        ...
        <div className="px-4 pt-3 pb-4">
          <div className="flex justify-between items-center mb-2.5">
            <div className="flex items-center gap-2">
              <div className={cn(
                ...
                {isStaging ? <PenSquare size={12} className="text-slate-500" /> : <GitCommit size={12} className="text-blue-600" />}
              </div>
              <span
                className={cn(
          ...
          <div className="flex justify-between items-center text-xs">
            ...
            {isStaging ? (
              ...
              <span className="text-slate-400 text-[0.7rem] truncate max-w-[120px]">{data.summary || data.timestamp}</span>
            )}
          </div>
        </div>
...
function LeafStatusIndicator({ leafType, data }: { leafType: LeafType; data: CanvasNodeData }) {
  const baseClasses = 'inline-flex items-center gap-1 text-[0.65rem] font-medium px-1.5 py-0.5 rounded'
