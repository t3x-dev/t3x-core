...
import type { Node, ColorMode } from '@xyflow/react'
      ...
      <div className="absolute left-1/2 top-14 z-10 -translate-x-1/2 -translate-y-1/2">
        <div className="relative flex h-9 rounded-full border border-border/60 bg-background/90 p-1 shadow-lg backdrop-blur-md">
          <div
            ...
            style={{ transform: mode === 'editor' ? 'translateX(4px)' : 'translateX(calc(100% + 4px))' }}
          />
          <button
            className={cn(
              'relative z-10 rounded-full px-4 text-xs font-medium transition-colors duration-200',
              mode === 'editor' ? 'text-primary-foreground' : 'text-muted-foreground hover:text-foreground'
            )}
          ...
          <button
            className={cn(
              'relative z-10 rounded-full px-4 text-xs font-medium transition-colors duration-200',
              mode === 'execution' ? 'text-primary-foreground' : 'text-muted-foreground hover:text-foreground'
            )}
