...
export function DiffTreeOverview({
	diff,
	baseContent,
	targetContent,
}: DiffTreeOverviewProps) {
	...
	const targetTree = buildFrameTree(
		targetContent,
		diffStatusMap,
		targetRootId,
	);
	...
	const baseRoot = baseRootId
		? baseContent.frames.find((f) => f.id === baseRootId)
		: undefined;
		...
		<div className="text-[11px]">
			...
			<div className="mb-3">
				...
				{diff.topicChanged ? (
					<div
						className="font-mono"
						style={{ fontSize: "10.5px", lineHeight: 1.6 }}
					>
			...
			<div className="mb-3">
				...
				<div className="flex gap-2">
					<TreeColumn
						label="Base"
						labelColor="var(--dy-removed-accent)"
						trees={baseTree}
					/>
					<TreeColumn
						label="Target"
						labelColor="var(--dy-added-accent)"
						trees={targetTree}
					/>
				</div>
			</div>
