  ...
  const buttons: ButtonConfig[] = [
    {
      ...
      activeClass: 'bg-red-100 dark:bg-red-900/30 border-red-300 dark:border-red-700 text-red-700 dark:text-red-300',
      shortcut: 'A',
    },
    {
      resolution: 'target',
      ...
      activeClass: 'bg-green-100 dark:bg-green-900/30 border-green-300 dark:border-green-700 text-green-700 dark:text-green-300',
      shortcut: 'B',
    },
    {
      resolution: 'both',
      ...
      label: 'Keep Both',
      activeClass: 'bg-blue-100 dark:bg-blue-900/30 border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-300',
      shortcut: 'X',
    },
    {
      resolution: 'edit',
      ...
      label: 'Edit',
      activeClass: 'bg-purple-100 dark:bg-purple-900/30 border-purple-300 dark:border-purple-700 text-purple-700 dark:text-purple-300',
      shortcut: 'E',
    },
  ];
