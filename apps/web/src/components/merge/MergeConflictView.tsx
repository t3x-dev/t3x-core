  ...
  return (
    <div
      className={cn(
        ...
        resolved ? 'border-green-200 dark:border-green-800 bg-green-50/30 dark:bg-green-950/30' : 'border-yellow-200 dark:border-yellow-800 bg-yellow-50/30 dark:bg-yellow-950/30'
      )}
    >
      {/* Header */}
      <ConflictHeader
