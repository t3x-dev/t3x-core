...
export default function AccessPage() {
  return (
    <div className="mx-auto max-w-2xl px-8 py-8">
      <h1 className="text-xl font-semibold text-[var(--text-primary)]">Access</h1>
      <p className="mt-1 mb-8 text-sm text-[var(--text-secondary)]">
        Manage workspace members, invitations, API keys, and local client access.
      </p>
      <div className="mb-8">
        <NamespaceCollaborationPanel />
      </div>
