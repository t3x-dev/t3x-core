...
exports.allGoldConversations = exports.goldConversations = exports.goldConversationsV2 = exports.diffExplainConversations = exports.signatureAuditConversations = exports.conflictConversations = exports.mergeSuccessConversations = exports.branchConversations = exports.zhGoldConversationsV2 = exports.enGoldConversationsV2 = void 0;
/* ===================== 英文段（与上版相同，补充可选字段） ===================== */
exports.enGoldConversationsV2 = [
    {
...
/* ===================== B. 合并成功（3 条） ===================== */
exports.mergeSuccessConversations = [
    {
...
/* ===================== D. 签名与审计（3 条，总数达标） ===================== */
exports.signatureAuditConversations = [
    {
...
/* ===================== E. 变更解释（4 条，总数达标） ===================== */
exports.diffExplainConversations = [
    {
...
exports.goldConversations = exports.goldConversationsV2.map(({ id, turns, expectedTopAspectContains }) => ({ id, turns, expectedTopAspectContains }));
/** 向后兼容：保留过往命名 allGoldConversations */
exports.allGoldConversations = exports.goldConversations;
/** 也可导出默认（兼容你原本只 import goldConversations 的写法） */
exports.default = exports.goldConversations;
