...
| Demonstration commit | Clarify the export acceptance criterion |
| `t3x/product-brief@1.0.0` | Companion YSchema definition; binding remains explicit |

## Verification boundary

Checks required fields and acceptance text. It does not prove that a requirement has been implemented.
