...
| Demonstration commit | Restrict the web service to a local port |
| `t3x/compose-services@1.0.0` | Companion YSchema definition; binding remains explicit |

## Verification boundary

Checks the supported services shape. Native Docker Compose validation, image availability and deployment have not run.
