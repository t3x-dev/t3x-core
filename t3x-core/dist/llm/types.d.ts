...
export interface LLMProvider {
     ...
     */
    resolveConflict(baseText: string | null, sourceText: string | null, targetText: string | null, context?: string): Promise<string>;
}
/**
 * LLM Provider error
 */
export declare class LLMProviderError extends Error {
    ...
    constructor(providerId: string, statusCode: number | undefined, message: string);
}
